<section
    id="home"
    class="relative flex min-h-screen items-center overflow-hidden bg-gradient-to-br from-gray-900 via-black to-red-950 pt-24 text-white md:pt-0"
>
    <!-- Animated Background Elements -->
    <div class="absolute inset-0 overflow-hidden opacity-20">
        <div
            class="absolute top-20 left-10 h-72 w-72 animate-pulse rounded-full bg-red-600 blur-3xl"
        ></div>
        <div
            class="absolute right-10 bottom-20 h-96 w-96 animate-pulse rounded-full bg-red-800 blur-3xl"
            style="animation-delay: 1s"
        ></div>
        <div
            class="absolute top-1/2 left-1/2 h-64 w-64 -translate-x-1/2 -translate-y-1/2 animate-pulse rounded-full bg-red-700 blur-3xl"
    ...
    <div class="relative z-10 container mx-auto px-4 py-0 md:py-24 2xl:py-0">
        <div class="flex flex-col items-center md:flex-row">
            ...
            <div class="font-jkt-sans mb-8 md:mb-0 md:w-1/2 md:pr-12">
                ...
                <h1
                    class="mb-6 text-4xl leading-tight font-bold tracking-tight lg:text-5xl xl:text-6xl"
                >
                    <span
                        class="bg-gradient-to-r from-white via-gray-200 to-red-400 bg-clip-text text-transparent"
                    >
                        Himpunan Mahasiswa
                    </span>
                    <br />
                ...
                <p
                    class="mb-8 text-lg leading-relaxed font-light text-gray-300"
                >
                ...
                <!-- Stats -->
                <div
                    class="mt-12 grid grid-cols-3 gap-6 border-t border-white/10 pt-8"
                >
                    <div>
            ...
            <div class="relative flex justify-center py-16 md:w-1/2">
                ...
                <div class="relative">
                    <!-- Floating Cards -->
                    <div class="relative h-96 w-80 lg:h-[28rem] lg:w-96">
                        <!-- Card 1 - Main -->
                        <div
                            class="absolute inset-0 rounded-3xl bg-gradient-to-br from-red-600 to-red-900 p-8 shadow-2xl shadow-red-900/50 backdrop-blur-sm"
                        >
                            <div class="flex h-full flex-col justify-between">
                                <div>
                                    <div
                                        class="mb-4 inline-block rounded-full bg-white/20 p-3 backdrop-blur-sm"
                                    >
                                        <svg
                        ...
                        <!-- Card 2 - Floating -->
                        <div
                            class="animate-float absolute -top-6 -right-6 h-32 w-32 rounded-2xl bg-gradient-to-br from-white to-gray-200 p-4 shadow-xl"
                        >
                            <div
                        ...
                        <!-- Card 3 - Floating -->
                        <div
                            class="animate-float absolute -bottom-14 -left-12 rounded-2xl bg-black/50 p-4 shadow-xl backdrop-blur-sm"
                            style="animation-delay: 1s"
                        >
                            <div class="flex items-center gap-3">
                                <div
                                    class="flex h-12 w-12 items-center justify-center rounded-full bg-red-600"
                                >
                                    <svg
