<footer class="relative overflow-hidden bg-gray-900 bg-linear-to-r via-black to-red-950 text-white">
    <div class="absolute top-0 left-0 h-1 w-full bg-linear-to-r from-teal-500 via-cyan-400 to-teal-500"></div>
    ...
    <div class="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
        <div class="grid grid-cols-1 items-start gap-12 lg:grid-cols-2 lg:gap-8">
            <div class="space-y-6">
                ...
                <div class="max-w-md">
                    <h3
                        class="bg-linear-to-r from-teal-300 to-cyan-100 bg-clip-text text-2xl font-bold text-transparent">
                        HMIF UKRI
                    </h3>
