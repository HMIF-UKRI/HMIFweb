<section id="board" class="relative overflow-hidden bg-black py-20 text-white">
    ...
    <div class="relative container mx-auto px-6 md:px-12">
        <div class="mb-16 text-center">
            <h2
                class="mb-3 text-3xl font-bold tracking-tight text-white sm:text-4xl"
            >
                Struktur Badan
                <span class="text-red-600">Pengurus</span>
            </h2>
            <div
                class="mx-auto h-1 w-24 rounded-full bg-gradient-to-r from-red-900 to-red-600"
            ></div>
        </div>
        ...
        <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
            @forelse ($members as $member)
                ...
                >
                    ...
                    <div class="relative p-6 text-center">
                        ...
                        <h3
                            class="relative text-lg font-bold text-white transition-colors group-hover:text-red-50"
                        >
                            {{ $member->name }}
                        </h3>
            ...
            @empty
                <div
                    class="col-span-full rounded-2xl border border-dashed border-red-900/30 py-12 text-center"
                >
        ...
        <div class="mt-8 text-center">
            <a
                class="group relative inline-flex items-center overflow-hidden rounded-lg border-2 border-current bg-transparent px-8 py-3 text-white transition-colors duration-300 hover:text-red-500 focus:ring-3 focus:outline-none"
                href="/kegiatan"
            >
                <span
