<section
    id="activities"
    class="relative overflow-hidden bg-gray-950 py-20 text-white"
>
    <div
    ...
    ></div>
    <div
        class="absolute right-0 bottom-0 -mr-20 -mb-20 h-96 w-96 rounded-full bg-red-900/10 blur-3xl"
    ></div>
    ...
    <div class="relative container mx-auto px-6 md:px-12">
        <div class="mb-16 text-center">
            ...
            <p class="mx-auto mt-4 max-w-2xl text-gray-400">
                Agenda dan aktivitas terbaru yang dilaksanakan oleh HMIF untuk
                ...
                >
                    <div class="relative h-56 w-full overflow-hidden">
                        ...
                        <div class="absolute top-4 right-4">
                            ...
                            >
                                <span
                                    class="mr-1.5 h-1.5 w-1.5 animate-pulse rounded-full bg-red-500"
                                ></span>
                    ...
                    <div class="flex flex-1 flex-col p-6">
                        ...
                        <p
                            class="mb-6 line-clamp-3 flex-1 text-sm leading-relaxed text-gray-400"
                        >
