<x-app-layout>
    <x-slot name="meta">
        @include('components._meta', [
            'title' => 'Drafting New Article - HMIF Insight',
            'description' => 'Mulai merangkai narasi wawasan teknologi di HMIF Dashboard.',
        ])
    </x-slot>

    <x-slot name="header_title">Blogs / New Draft</x-slot>

    <div x-data="{ imageUrl: null, status: 'draft' }" class="relative pb-32">
        @if (session('error'))
            <div
            ...
            <div
                ...
                <div class="flex items-center gap-6">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <span class="text-[9px] font-black text-gray-400 uppercase tracking-widest">Editing Draft</span>
                    </div>
                </div>
                ...
                <div class="relative group">
                    <div
                        ...
                        <template x-if="imageUrl">
                            <div class="contents">
                                ...
                                <div
                                    ...
                                    <span
                                        class="px-6 py-2 bg-white/10 backdrop-blur-md rounded-full text-[10px] font-black text-white uppercase tracking-widest border border-white/20">Change
                                        Cover Image</span>
                                </div>
                            </div>
                        </template>
                        ...
                        <div x-show="!imageUrl"
                            ...
                            <p class="text-[8px] text-gray-500 mt-2 font-bold italic uppercase tracking-widest">
                                Recommended 16:9 ratio</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white/2 border border-white/5 rounded-[4rem] p-8 md:p-20 shadow-2xl backdrop-blur-sm">
                    <div class="max-w-3xl mx-auto space-y-12">
                        ...
                        <div class="flex flex-wrap items-center gap-4 border-b border-white/5 pb-8">
                            ...
                            <div class="h-4 w-px bg-white/10"></div>
                            <span class="text-[9px] font-black text-gray-600 uppercase tracking-widest italic">Author:
                                Admin</span>
                        </div>
                        ...
                        <div class="space-y-6">
                            <div class="space-y-4 relative group">
                                <textarea name="title" rows="1" required
                                    ...
                                    placeholder="Enter Title..." oninput="this.style.height = '';this.style.height = this.scrollHeight + 'px'">{{ old('title') }}</textarea>
                                <div
                            ...
                            <textarea name="summary" rows="2" required maxlength="255"
                                class="summary-textarea w-full bg-transparent border-none p-0 text-base md:text-xl font-medium text-gray-500 placeholder-white/5 outline-none resize-none overflow-hidden leading-relaxed italic"
                                placeholder="A brief summary of your story..."
                                oninput="this.style.height = '';this.style.height = this.scrollHeight + 'px'">{{ old('summary') }}</textarea>
                        </div>

                        <div id="editorjs" data-upload-url="{{ route('admin.blogs.upload-image') }}"
                            class="text-white min-h-125"></div>
                    </div>
                </div>
