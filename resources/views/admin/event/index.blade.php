                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y-2 divide-gray-200">
                        <thead class="ltr:text-left rtl:text-right">
                            <tr class="*:font-medium *:text-gray-900 *:first:sticky *:first:bg-white">
                        ...
                        <tbody class="divide-y divide-gray-200">
                            @foreach ($events as $event)
                                <tr
                                    ...
                                    <td class="px-3 py-2 whitespace-nowrap">
                                        @if ($event->thumbnail_path)
                                            <img src="{{ asset('storage/' . $event->thumbnail_path) }}"
                                                alt="{{ $event->title }}" class="h-10 w-10 rounded-md object-cover" />
                                        @else
                                    ...
                                    <th class="border-l border-gray-200 px-3 py-2 text-center whitespace-nowrap">
                                        <span
                                            ...
                                            onclick="window.location.href='{{ route('events.edit', $event->id) }}'">
