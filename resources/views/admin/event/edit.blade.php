<x-app-layout>
    ...
    <x-slot name="header_title">Content / Events / Edit</x-slot>

    <div x-data="{
        imageUrl: '{{ $event->getFirstMediaUrl('thumbnails') }}',
        status: '{{ $event->status }}',
        mode: @js(old('event_mode', $event->event_mode ?? 'attendance'))
                ...
                <div
                    ...
                    <div class="max-w-3xl mx-auto space-y-8">
                        ...
                        <div class="space-y-4">
                            <div class="group relative">
                                ...
                                <textarea name="title" rows="1" required
                                    ...
                                    placeholder="Event Title..." oninput="this.style.height = '';this.style.height = this.scrollHeight + 'px'">{{ old('title', $event->title ?? '') }}</textarea>
                                <div
                            ...
                            <div class="group relative">
                                ...
                                <textarea name="short_description" rows="2" required maxlength="255"
                                    ...
                                    placeholder="Briefly explain what this event is about...">{{ old('short_description', $event->short_description ?? '') }}</textarea>
                            </div>
                        </div>
                        ...
                        <div id="editorjs" data-upload-url="{{ route('admin.events.upload-image') }}"
                            data-initial='{!! $event->description !!}' class="text-white"></div>
                    </div>
                </div>
                                    ...
                                    <div class="grid grid-cols-2 gap-3">
                                        <label
                                            ...
                                            <input type="radio" name="event_mode" value="attendance"
                                                ...
                                                {{ old('event_mode', $event->event_mode ?? 'attendance') === 'attendance' ? 'checked' : '' }}>
                                        ...
                                        <label
                                            ...
                                            <input type="radio" name="event_mode" value="registration"
                                                class="sr-only" x-model="mode"
                                                {{ old('event_mode', $event->event_mode ?? 'attendance') === 'registration' ? 'checked' : '' }}>
