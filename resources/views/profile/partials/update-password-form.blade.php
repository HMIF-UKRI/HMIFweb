<section>
    <header>
        ...
        <p class="mt-1 text-sm text-gray-400">
            {{ __('Pastikan akun Anda menggunakan password yang panjang dan acak untuk menjaga keamanan data organisasi.') }}
        </p>
    </header>
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
        ...
        <div class="flex items-center gap-4">
            <x-primary-button>{{ __('Ganti Password') }}</x-primary-button>
