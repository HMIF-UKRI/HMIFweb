<x-guest-layout>
    ...
    <div
        ...
        x-data="eventFilter(@js($events))"
    >
        <div
            class="relative flex h-[50vh] min-h-100 w-full items-center justify-center overflow-hidden"
        >
            <div class="absolute inset-0 z-0">
                ...
                />
                <div
                    class="absolute inset-0 bg-linear-to-t from-gray-950 via-gray-900/80 to-red-900/20"
                ></div>
                <div
            ...
            <div class="z-10 container mx-auto px-4 text-center">
                ...
                >
                    Kegiatan
                    <span
                        class="bg-linear-to-r from-red-500 to-orange-500 bg-clip-text text-transparent"
                    >
                        HMIF
                    </span>
                </h1>
            ...
            <div class="container mx-auto px-4 sm:px-6 lg:px-8">
                <div class="lg:grid lg:grid-cols-4 lg:gap-8">
                                    ...
                                    <div>
                                        ...
                                        <div class="relative">
                                            <select
                                                x-model="status"
                                                name="sortByStatus"
                                                class="w-full cursor-pointer appearance-none rounded-lg border border-white/10 bg-gray-900 py-2.5 pr-8 pl-3 text-sm text-white focus:border-red-500 focus:ring-1 focus:ring-red-500 focus:outline-none"
                                            >
                                                <option value="all">
                                                    Semua Status
                                                </option>
                    ...
                    <div class="lg:col-span-3">
                        ...
                        >
                            <template
                                x-for="event in filteredEvents.slice(0, limit)"
                                :key="event.slug"
                            >
                                <article
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        />
                                        <div
                                            class="absolute top-3 left-3 rounded-lg bg-black/60 px-3 py-1 text-center backdrop-blur"
                                        >
                                            <span
                                                class="block text-xs font-bold text-red-500"
                                                x-text="event.day"
                                            ></span>
                                            <span
                                    ...
                                    <div class="flex flex-1 flex-col p-5">
                                        <span
                                            x-html="getStatusBadge(event.status)"
                                        ></span>
                                        <h3
                                            class="mt-2 line-clamp-2 text-xl font-bold text-white group-hover:text-red-500"
                                            x-text="event.title"
                                        ></h3>
                                        <p
                                            class="mt-3 line-clamp-3 text-sm text-gray-400"
                                            x-text="event.short_description"
                                        ></p>
                                        <a
                                            :href="'/kegiatan/' + event.slug"
                                            class="mt-auto pt-4 text-sm font-medium text-white hover:text-red-400"
                                        >
                                            Lihat Detail →
                                        </a>
                                    </div>
                        ...
                        <div
                            ...
                            x-show="limit < filteredEvents.length"
                        >
                            <button
                                @click="limit += 6"
