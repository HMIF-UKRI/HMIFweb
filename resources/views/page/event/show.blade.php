...
@section("content")
    <section class="pt-20">
        <div class="container mx-auto px-4 py-8 sm:px-6 lg:px-8">
            <a
                href="/kegiatan"
                class="mb-5 inline-flex items-center font-semibold text-red-600 transition duration-300 ease-in-out hover:text-red-700"
            >
                <svg
                    class="mr-2 h-5 w-5"
                    fill="none"
            ...
            <main class="mb-8 grid grid-cols-1 gap-8 lg:grid-cols-3">
                ...
                >
                    ...
                    <div
                        class="relative mb-6 overflow-hidden rounded-lg shadow-md"
                    >
                        <!-- Thumbnail -->
                        <img
                        ...
                        ></div>
                        <div
                            class="absolute bottom-0 left-0 w-full p-6 text-white"
                        >
                            <span
