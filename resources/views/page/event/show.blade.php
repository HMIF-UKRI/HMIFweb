...
@section("content")
    <div
        class="min-h-screen bg-gray-950 font-sans text-white selection:bg-red-500 selection:text-white"
    >
        <div
        ...
        <div class="relative h-[55vh] min-h-[450px] w-full overflow-hidden">
            <img
            ...
            <div
                class="absolute inset-0 bg-gradient-to-t from-gray-950 via-gray-950/70 to-black/30"
            ></div>

            <div
                class="pointer-events-none absolute bottom-0 left-1/2 h-[300px] w-[60%] -translate-x-1/2 translate-y-1/2 rounded-full bg-red-900/50 blur-[120px]"
            ></div>

            <div
                class="absolute inset-0 flex flex-col justify-end pb-12 sm:pb-16"
            >
                <div
                    class="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8"
                >
                    <div
                    ...
                    >
                        ...
                        >
                            <a href="/" class="transition hover:text-red-500">
                                Beranda
                            </a>
                    ...
                    <div class="flex flex-col gap-4">
                        <div>
                            ...
                            >
                                {{ $event->eventCategory->name ?? "Event HMIF" }}
                            </span>
                        </div>
                        ...
                        <div
                            class="mt-2 hidden items-center gap-6 text-gray-300 sm:flex"
                        >
                            <div class="flex items-center gap-2">
                                <i
                                    class="fa-regular fa-calendar text-red-500"
                                ></i>
                                <span>
                            ...
                            <div class="flex items-center gap-2">
                                <i
                                    class="fa-solid fa-location-dot text-red-500"
                                ></i>
        ...
        <div
            class="relative z-10 container mx-auto -mt-8 px-4 pb-20 sm:px-6 lg:px-8"
        >
            <div class="grid grid-cols-1 gap-8 lg:grid-cols-12">
                <div class="space-y-8 lg:col-span-8">
                    ...
                    >
                        <div
                            class="mb-8 rounded-xl border-l-4 border-red-600 bg-red-900/10 p-5"
                        >
                            <p
                                class="text-lg leading-relaxed font-medium text-gray-200 italic"
                            >
                        ...
                        >
                            ...
                            <div class="flex gap-3">
                                ...
                                >
                                    <i
                                        class="fa-brands fa-facebook-f text-lg"
                                    ></i>
                                </a>
                                <button
                ...
                <div class="lg:col-span-4">
                    <div class="sticky top-24 space-y-6">
                        ...
                        >
                            ...
                            >
                                <i
                                    class="fa-solid fa-circle-info text-red-500"
                                ></i>
                                Detail Acara
                            </h3>
                            ...
                            <div class="space-y-6">
                                <div>
                                    <p
                                        class="mb-2 text-xs font-bold text-gray-500 uppercase"
                                    >
                                        Status
                                    </p>
                                ...
                                <div class="flex items-start gap-4">
                                    ...
                                    >
                                        <i
                                            class="fa-regular fa-calendar-check text-lg"
                                        ></i>
                                    </div>
                                    <div>
                                        <p
                                        ...
                                        <p
                                            class="mt-0.5 font-semibold text-white"
                                        >
                                            {{ \Carbon\Carbon::parse($event->event_date)->translatedFormat("l, d F Y") }}
                                        </p>
                                    </div>
                                ...
                                <div class="flex items-start gap-4">
                                    ...
                                    >
                                        <i
                                            class="fa-solid fa-map-location-dot text-lg"
                                        ></i>
                                    </div>
                                    <div>
                                        <p
                                        ...
                                        <p
                                            class="mt-0.5 leading-snug font-semibold text-white"
                                        >
                                            {{ $event->location }}
                                        </p>
                                        <a
                            ...
                            <div class="mt-8 border-t border-white/10 pt-6">
                                @if ($event->status == "upcoming")
                                    ...
                                    <p
                                        class="mt-3 text-center text-[10px] text-gray-500"
                                    >
                        ...
                        >
                            <p
                                class="mb-3 text-xs font-bold text-gray-500 uppercase"
                            >
                ...
                <div class="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="mb-10 flex items-center justify-between">
                        <div>
                            ...
                            <div
                                class="mt-2 h-1 w-16 rounded-full bg-red-600"
                            ></div>
                        </div>
                        <a
                            href="/kegiatan"
                            class="text-sm font-medium text-red-500 transition hover:text-white"
                        >
                            Lihat Semua
