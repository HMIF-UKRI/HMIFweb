...
@section("content")
    <div class="bg-white">
        ...
        <div
            class="relative overflow-hidden bg-gradient-to-r from-red-950 via-red-900 to-red-950 py-6"
        >
            <!-- Animated Background Lines -->
            <div class="absolute inset-0 opacity-20">
                <div
                    class="animate-slide absolute h-full w-1 bg-white"
                    style="left: 20%; animation-delay: 0s"
                ></div>
                <div
                    class="animate-slide absolute h-full w-1 bg-white"
                    style="left: 40%; animation-delay: 0.5s"
                ></div>
                <div
                    class="animate-slide absolute h-full w-1 bg-white"
            ...
            <!-- Top Border -->
            <div
                class="absolute top-0 right-0 left-0 h-px bg-gradient-to-r from-transparent via-red-400 to-transparent"
            ></div>
            ...
            <!-- Bottom Border -->
            <div
                class="absolute right-0 bottom-0 left-0 h-px bg-gradient-to-r from-transparent via-red-400 to-transparent"
            ></div>
        </div>
